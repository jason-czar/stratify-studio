...
// Export the core evaluation function directly for use outside of React components
export const evaluateCondition = (condition: ConditionData, marketData: MarketData): boolean => {
...
export const useConditionEvaluation = () => {
  const evaluateConditionCallback = useCallback(evaluateCondition, []);

  return { evaluateCondition: evaluateConditionCallback };
};
